...
aula = {"numero": 301, "nombre": "Alguén famoso", "numeroPostos": 10}

# print("{} => {}".format(clave, aula[clave]))

# "{} => {}".format(clave, aula[clave]) → formatea la cadena:

# El primer {} se reemplaza por clave

# El segundo {} se reemplaza por aula[clave] → el valor asociado a la clave

# Resultado: imprime cada par clave => valor del diccionario

for clave in aula.keys():
    print("{} => {}".format(clave, aula[clave]))
